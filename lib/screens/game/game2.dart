...
class _QuizScreenState extends State<QuizScreen> {
  ...
  List<Question> questions = [
    ...
    Question(
      imagePath: 'assets/images/crayonsGame.png',
      clue: "7 LETTERS",
      descp:
    ...
    Question(
      imagePath: 'assets/images/eraserGame.png',
      clue: "6 LETTERS",
      descp:
    ...
    Question(
      imagePath: 'assets/images/notebookGame.png',
      clue: "8 LETTERS",
      descp:
    ...
    Question(
      imagePath: 'assets/images/pencilGame.png',
      clue: "6 LETTERS",
      descp:
    ...
    Question(
      imagePath: 'assets/images/rulerGame.png',
      clue: "6 LETTERS",
      descp:
    ...
    Question(
      imagePath: 'assets/images/scissorGame.png',
      clue: "7 LETTERS",
      descp:
    ...
    Question(
      imagePath: 'assets/images/shoesGame.png',
      clue: "5 LETTERS",
      descp:
